...
public class NoticeForList {
    ...
    public NoticeForList(int noticeNo, String noticeName, String noticeContent, Date noticeRegistDate, String noticeStatus, Admin admin, int noticeCount, NoticeCategory noticeCategory) {
